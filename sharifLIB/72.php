...
$x=$_REQUEST['a'];
	...
	$fields = array( 
				...
				'CircDBsLB'=>"SName=Sharif_Central_Library, HostURL=, CompName=DELTA, CName=Ù?ØªØ§Ø¨Ø®Ø§Ù?Ù? Ù?Ø±Ù?Ø²Ù? Ø¯Ø§Ù?Ø´Ú¯Ø§Ù? Ø´Ø±Ù?Ù,DBName=_CircXP_sharif,Group=,STDate=0.00,FDate=1",
				'MemberNumIL'=>86108177 ,
				'MemBarcodeIL'=>$x ,
				'PasswordIL'=>$x 
			);
